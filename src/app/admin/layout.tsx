  ...
  if (!user) {
    return (
      <div className="relative min-h-screen bg-[#F4F5FA] text-[#3A3541]">
        ...
        <div className="fixed bottom-0 left-0 -z-10 opacity-60">
          <svg width="200" height="200" viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
            <circle cx="20" cy="180" r="100" fill="#9155FD" fillOpacity="0.1" />
            <path d="M40 200C40 160 80 140 100 100" stroke="#9155FD" strokeOpacity="0.2" strokeWidth="2" />
            <path d="M20 200C20 150 50 120 70 80" stroke="#9155FD" strokeOpacity="0.1" strokeWidth="2" />
          </svg>
        </div>
        ...
        <div className="flex h-full flex-col overflow-y-auto px-4 py-6">
          ...
          <div className="mt-auto border-t border-[#3A3541] border-opacity-[0.12] pt-4">
            <div className="flex items-center gap-3 px-2 py-3">
              <div className="flex h-8 w-8 items-center justify-center rounded-full bg-[#9155FD] text-[10px] font-bold text-white uppercase">
                {user.email[0]}
              </div>
              <div className="flex-1 overflow-hidden text-xs">
                <p className="truncate font-semibold text-[#3A3541] opacity-[0.87]">{user.email}</p>
                <p className="text-[10px] text-[#3A3541] opacity-[0.38] uppercase tracking-wider">{user.role}</p>
              </div>
            </div>
            <a
              href="/admin/logout"
              className="mt-2 flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium text-[#FF4D49] transition-colors hover:bg-red-50"
            >
