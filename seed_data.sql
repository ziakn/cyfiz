...
-- Seed team members
INSERT INTO team_members (initials, name, role, bio, expertise, portfolio_highlights, portfolio_url) VALUES
('ZM', 'Zia Muhammad', 'CoFounder | Software Engineer', 'Full Stack Software Engineer in Qatar with 7+ years of experience delivering scalable web, mobile, API, and cloud solutions for media, eCommerce, SaaS, and government platforms. His work includes high-traffic news platforms, multi-country SaaS products, complex data migrations, and secure REST API integrations.', 'Laravel, React.js, Vue.js, Next.js, React Native, REST APIs, MySQL, PostgreSQL, Linux, Nginx', 'Al Sharq News - leading Arabic daily in Qatar with 85M+ views
The Peninsula Qatar - English news site with 65M+ views
Tiollo - multi-country SaaS solution
Dar Al Sharq Group - centralized publishing systems
Qatar Press Centre - journalist and influencer media hub
Bon and Bean - specialty coffee e-commerce', 'https://www.ziamuhammad.com/');
